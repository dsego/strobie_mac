...
MAC_FLAGS	= -Wno-direct-ivar-access -Wno-objc-missing-property-synthesis -Wno-implicit-atomic-properties
...
mac:
	make engine
	cc $(FLAGS) $(MAC_FLAGS) -arch x86_64 -fobjc-arc -O3 $(FFTS) $(PORTAUDIO) $(DSP) \
